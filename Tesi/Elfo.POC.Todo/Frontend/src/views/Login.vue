    ...
    >
      ...
      <!-- bottoni -->
        <v-card-actions class="justify-center item-box">
          <v-btn class="custom-btn" prepend-icon="mdi-account" @click="login">Login</v-btn>
          <v-btn class="custom-btn cancel-btn" prepend-icon="mdi-close" @click="close">Chiudi</v-btn>
        </v-card-actions>
