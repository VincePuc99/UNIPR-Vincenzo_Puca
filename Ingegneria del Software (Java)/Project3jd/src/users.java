/* class users extends person and contains the login of every user and let you login if already registered */
public class users extends person {
    ...
    /* contains every info of existing users */
