public class wine {
    ...
    public int searchwine(String winn,String yea) throws InterruptedException {//
        ...
        System.out.println("Wine not available");
        return 0;
        }
        ...
        public boolean buywine(int quant,int avail){//
            if(quant<=avail)
            {
              ...
              System.out.println("Your quantity exceeds ours depot,try again");
            }
          return false;
        }

      private void showwineinfo(){
        System.out.println("Producer: "+dbwine[savepos][1]);
        System.out.println("Technical notes: "+dbwine[savepos][3]);
        System.out.println("Varieties: "+dbwine[savepos][4]);
        System.out.println("Wine in depot: "+ dbnumberwine[savepos]);
      }
}
